...
import com.example.project_assignment1.databinding.ActivityUpdateBinding;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnUpdateTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseFirestore.collection("Expenses")
                        ...
                        .collection("Notes")
                        .document(id)
                        .update("amount", amount, "note", note, "type", type) // ใช้ newType แทน type ที่มาจาก Intent
        ...
        binding.btnDelteTransaction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                firebaseFirestore.collection("Expenses")
                        .document(firebaseAuth.getUid())
